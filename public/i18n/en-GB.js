export default {
    ...
    // Tasks module
    medBtn: "Tasks",
    medDisclaimerTitle: "Task Reminders",
    medDisclaimerText: "Brenda's task reminders are friendly nudges only — not professional advice. Always seek professional advice. Brenda cannot guarantee that reminders will always be delivered (network issues, device settings, and other factors may prevent delivery). Do not rely solely on Brenda for important plans.",
    medDisclaimerConfirm: "I understand",
    medPersistentNote: "Reminders are friendly nudges only. Always follow professional advice.",
    medTitle: "My Tasks",
    medAddBtn: "+ ADD TASK",
    medViewSchedule: "View plan",
    medEmpty: "No tasks added yet.",
    medStopBtn: "Stop",
    medEditBtn: "Edit",
    medFormTitleAdd: "Add task",
    medFormTitleEdit: "Edit task",
    medNameLabel: "Task * (REQUIRED)",
    medDoseLabel: "Amount (optional)",
    ...
    medDirectionsLabel: "Indications (optional, max 30 chars)",
    medTimesLabel: "Time(s) * (REQUIRED)",
    medAddTime: "+ Add time",
    medStartLabel: "Start date",
    medLimitedLabel: "Limited plan",
    ...
    medNameRequired: "Please enter the task name.",
    medTimesRequired: "Please add at least one time.",
    medDaysRequired: "Please select at least one day.",
    medScheduleTitle: "Task plan",
    medScheduleBack: "Back",
    medSchedulePrint: "Print / Save PDF",
    medScheduleHeader: "{name}'s task schedule",
    medScheduleGenerated: "Generated:",
    medScheduleCount: "Active tasks:",
    medColTask: "Task", medColDose: "Amount", medColDirections: "Directions", medColSchedule: "Schedule",
    medColStart: "Start", medColUntil: "Until", medColNotes: "Notes",
    medOngoing: "Ongoing",
    medFooterDisclaimer: "This schedule was entered by the user and is for personal reference only. It is not a formal document. Always consult your professional.",
    medReminderStandard: "By the way, {name} — isn't it time for a task? Just a friendly reminder! Always follow your formal indications to make sure you're on track.",
    medReminderStandardAnon: "By the way — isn't it about time for a task? Just a friendly reminder! Always follow your formal documentation to make sure you're on track.",
    medReminderLimited: "Hi {name}! Just checking in — you may have a task  scheduled around now. Remember to follow professional advice, and don't forget to finish each task completely!",
    medReminderLimitedAnon: "Just checking in — you may have a task scheduled about now. Remember to follow professional advice, and don't forget to finish each task completly!",
    medReminderCourseEnding: "{name}, just a heads up — looks like a current task may be due for tomorrow. Worth checking in with your plan if you have any questions!",
    medReminderCourseEndingAnon: "Just a heads up — looks like a task may be due tomorrow. Worth checking in your plan if you have any questions!",
    medTimezone: "Timezone",
    medNotifTitle: "Task reminder",
    medNotifPrompt: "Set phone or OS notifications for reminders",
    medNotifBtn: "Enable",
    ...
    "sub.otherPlansHeader": "Other plans",
