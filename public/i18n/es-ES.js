export default {
    ...
    // Módulo de Tareas
    medBtn: "Tareas",
    medDisclaimerTitle: "Recordatorios de tareas",
    medDisclaimerText: "Los recordatorios de tareas son solo avisos amistosos, no consejos profesionales. Sigue siempre indicaciones profesionales. Brenda no puede garantizar que los recordatorios se entreguen siempre (problemas de red, ajustes del dispositivo u otros factores pueden impedirlo). No dependas únicamente de Brenda para planes importantes.",
    medDisclaimerConfirm: "Lo entiendo",
    medPersistentNote: "Los recordatorios son solo avisos amistosos. Sigue siempre la información formal que tengas.",
    medTitle: "Mis Tareas",
    medAddBtn: "+ Añadir tarea",
    medViewSchedule: "Ver plan",
    medEmpty: "Aún no hay tareas añadidas.",
    medStopBtn: "Detener",
    medEditBtn: "Editar",
    medFormTitleAdd: "Añadir tarea",
    medFormTitleEdit: "Editar tarea",
    medNameLabel: "Tarea * (REQUERIDO)",
    medDoseLabel: "Cantidad (opcional)",
    ...
    medLimitedLabel: "Tarea con duración limitada",
    ...
    medNameRequired: "Por favor, introduce el nombre de la tarea.",
    medTimesRequired: "Por favor, añade al menos una hora.",
    medDaysRequired: "Por favor, selecciona al menos un día.",
    medScheduleTitle: "Plan de tareas",
    medScheduleBack: "Volver",
    medSchedulePrint: "Imprimir / Guardar PDF",
    medScheduleHeader: "Plan de tareas de {name}",
    medScheduleGenerated: "Generado:",
    medScheduleCount: "Tareas activas:",
    medColTask: "Tarea", medColDose: "Cantidad", medColDirections: "Indica", medColSchedule: "Horario",
    medColStart: "Inicio", medColUntil: "Hasta", medColNotes: "Notas",
    medOngoing: "Indefinido",
    medFooterDisclaimer: "Este plan de tareas ha sido introducido por el usuario y es solo de referencia personal. No es un documento formal. Consulta siempre un profesional cualificado.",
    medReminderStandard: "Por cierto, {name} — ¿no es hora de tu tarea? ¡Solo un recordatorio amistoso! Sigue siempre la documentación oficial para estar al día.",
    medReminderStandardAnon: "Por cierto — ¿no es hora de una tarea? ¡Solo un recordatorio amistoso! Sigue siempre la documentación oficial para estar al día.",
    medReminderLimited: "¡Hola, {name}! Solo quería avisarte — puede que tengas una tarea programada ahora. Recuerda seguir la documetación oficial para cumplir con tus tareas.",
    medReminderLimitedAnon: "Solo quería avisarte — puede que tengas una tarea programada ahora. Recuerda seguir la documentación oficial para completar tus tareas.",
    medReminderCourseEnding: "{name}, que sepas que tu tarea actual parece que termina mañana. Si tienes alguna duda, merece la pena consultar los documentos.",
    medReminderCourseEndingAnon: "Que sepas que tu tarea actual parece que termina mañana. Si tienes alguna duda, merece la pena consultar los papeles.",
    medTimezone: "Zona horaria",
    medNotifTitle: "Recordatorio de tarea",
    medNotifPrompt: "Activa las notificaciones del sistema para recibir recordatorios",
    medNotifBtn: "Activar",
